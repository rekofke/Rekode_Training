...
def get_user_bookings():
    ...
    return jsonify([{
        ...
        'date': b.workout_session.date.isoformat(),
        'startTime': b.workout_session.start_time.strftime('%H:%M'),
        'trainer': b.workout_session.trainer.first_name + ' ' + b.workout_session.trainer.last_name if b.workout_session.trainer else 'Unknown'
